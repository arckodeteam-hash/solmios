...
| **CurrencyAPI** | Free 0 USD / Small 9,99 USD-mes; Medium 39,99; Large 79,99 (20% dto. anual) | Free 300/mes; Small 15.000/mes; Medium 600.000/mes; Large 1.700.000/mes | Free diaria; Small horaria; Medium y Large cada 60 s | No verificado (descartado por licencia antes de evaluar cobertura) | **Free es "Private Use": prohíbe el uso comercial**; 10 req/min. Requiere API key |
...
2. **Catálogo completo del producto.** `backend/src/shared/currency.ts` define: USD, EUR, DOP, MXN,
   COP, ARS, BRL, PEN, CLP, GBP, CAD y CHF. El proveedor tiene que cubrir las doce.
...
- **Es la única gratuita que cubre DOP y el resto del catálogo.** Verificado con curl sobre
  ...
  CLP 933.491386, PEN 3.355232, MXN 16.932921 y BRL 5.126189.
