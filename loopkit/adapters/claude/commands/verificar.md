---
description: Auditar con minions lo que ya está escrito y arreglar lo que aparezca
---
# VERIFICAR el estado actual

Si no hay tarea abierta, abrí una:

```bash
bash .loopkit/core/lk start CHK-<id> "verificación del estado actual"
```

Después arrancá directamente en el **paso 2** del protocolo (auditoría paralela): no hace
falta implementar nada primero.
