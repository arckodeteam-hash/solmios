...
<p>SOLMI OS, nombre comercial registrado ante ONAPI bajo el número 941808, cuyo titular es Leonardo Batista Soliman, con domicilio en Calle Activo 2030, No. 34, Ensanche Ozama, Santo Domingo Este, República Dominicana.</p>
...
<p>Personas que interactúan con el asistente automatizado o reservan a través de los canales de un establecimiento cliente. Importante: el contrato de hospedaje, consumo o servicio se celebra directamente con el establecimiento, no con SOLMI OS. SOLMI OS es la herramienta tecnológica que facilita la comunicación y la gestión.</p>
...
<p>El software, la marca SOLMI OS, su logotipo, diseño e identidad visual son propiedad de Leonardo Batista Soliman y están protegidos por la Ley 20-00 sobre Propiedad Industrial. El registro del nombre comercial ante ONAPI (No. 941808) confiere protección por diez años desde el 13 de julio de 2026. Los datos y contenidos que cada establecimiento carga en la plataforma siguen siendo propiedad del establecimiento.</p>
...
<p>En la máxima medida permitida por la ley dominicana, SOLMI OS no responde por: actos, omisiones, tarifas o incumplimientos del establecimiento; interrupciones causadas por proveedores externos; pérdidas indirectas, lucro cesante o daño reputacional; ni errores derivados de datos incorrectos suministrados por el usuario. Nada en esta cláusula limita la responsabilidad que por ley no puede excluirse, incluidos los derechos que otorga la Ley 358-05 de Protección de los Derechos del Consumidor.</p>
<h2>12. Privacidad</h2>
...
<h2>16. Contacto</h2>
<p>SOLMI OS — Leonardo Batista Soliman. Calle Activo 2030, No. 34, Ensanche Ozama, Santo Domingo Este, República Dominicana. <em>[pendiente: correo y teléfono de contacto]</em></p>`,
    },
    {
...
<p>SOLMI OS es un nombre comercial registrado ante la Oficina Nacional de la Propiedad Industrial (ONAPI) de la República Dominicana bajo el número de registro 941808, cuyo titular es Leonardo Batista Soliman. SOLMI OS es una plataforma de gestión hotelera (PMS) que incluye un asistente de atención automatizada por WhatsApp, Instagram y Facebook Messenger.</p>
<ul>
<li><strong>Responsable del tratamiento:</strong> Leonardo Batista Soliman (SOLMI OS)</li>
<li><strong>Domicilio:</strong> Calle Activo 2030, No. 34, Ensanche Ozama, Santo Domingo Este, Provincia Santo Domingo, República Dominicana</li>
<li><strong>Correo de contacto:</strong> <em>[pendiente]</em></li>
<li><strong>Teléfono:</strong> <em>[pendiente]</em></li>
</ul>
<h2>2. Qué es esta política</h2>
<p>Este documento explica qué datos personales recogemos, para qué los usamos, con quién los compartimos, cuánto tiempo los conservamos y qué derechos tienes sobre ellos. Aplica a todas las personas que interactúan con SOLMI OS: huéspedes de los hoteles que usan nuestra plataforma, personal de esos hoteles, y visitantes de nuestro sitio web. Se rige por la Ley No. 172-13 sobre Protección de Datos Personales de la República Dominicana.</p>
...
<p>Tienes derecho a: acceder a los datos que tenemos sobre ti, rectificar los datos inexactos o incompletos, solicitar la eliminación de tus datos, oponerte al tratamiento o limitarlo, retirar tu consentimiento en cualquier momento, portabilidad (recibir tus datos en un formato legible), y presentar una reclamación ante la autoridad competente.</p>
<p>Para ejercerlos, escríbenos a <em>[pendiente]</em>. Responderemos en un plazo máximo de quince (15) días hábiles. Para eliminar tus datos, consulta también nuestra página de Eliminación de Datos.</p>
...
<p>Llena el formulario en <em>[pendiente: URL del formulario]</em> con tu nombre completo, el número de teléfono o usuario con el que nos escribiste, y el hotel o establecimiento con el que interactuaste, si lo recuerdas.</p>
<h3>2. Por correo electrónico</h3>
<p>Escribe a <em>[pendiente]</em> con el asunto "Eliminación de datos" e incluye los mismos datos de arriba.</p>
...
<ul>
<li>Escribe a <em>[pendiente]</em> desde el correo del administrador registrado.</li>
