...
export interface RoomLineInput {
   ...
   *  tipo y `needsCrib` persistido en TODAS las filas de la línea como espejo exacto de su línea
   *  de cuna.
...
export async function createPublicBookingGroup(
  ...
  for (const [lineIndex, line] of lines.entries()) {
    ...
    // vendible del TIPO ofrece una fila cuna? — se cierra DESPUÉS de `resolveRoomAmenityLines`
    // contra la unión del tipo. Sí/No únicamente — `cribCount` es 1/0 espejo de `needsCrib`,
    // nunca una cantidad elegible.
