...
import { canSeeAnnouncement } from './announcement-audience'
...
async function visibleAnnouncementOrThrow(
  ...
  // Global (sin hotel) o del hotel del usuario (ANN-1): un global se marca desde cualquier hotel.
  if (currentUser.role !== 'super_admin' && !canSeeAnnouncement(item, hotelId)) {
