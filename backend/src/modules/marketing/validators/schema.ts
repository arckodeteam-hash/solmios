...
export const CreateAutoMessageSchema: Record<string, ValidationRule> = {
  ...
  event: { type: 'string' as const, enum: ['reservation_confirmed','reservation_presale','checkin_welcome','no_show','checkout','invoice','reminder','reservation_approved','reservation_rejected'] },
