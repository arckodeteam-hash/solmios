...
| ✅ 2026-09-12 (`registered: true`, id `a9aa5db4-…`, 3 eventos de booking, cuenta entera) | **Webhook registrado** en la cuenta (`POST /api/admin/channex-webhook`) | https://solmios.com/admin/channels → tarjeta de cuenta → Webhook | Pre-flight P4 y Test 11 "recomendado"; el cron de 15 min queda de respaldo |
