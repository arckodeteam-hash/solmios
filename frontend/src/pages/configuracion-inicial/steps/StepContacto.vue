    ...
    <template v-else>
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <PhoneInput v-model="form.phone2" :country="country" pill :maxlength="20" />
        </div>
        <div>
...
// Solo para el prefijo/formato de PhoneInput — este paso no lo guarda (se edita en Bienvenida),
// mismo criterio que StepUbicacion.vue con el mapa.
const country = ref('')
