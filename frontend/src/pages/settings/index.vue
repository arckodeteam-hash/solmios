...
const tabGroups: SettingsTabGroup[] = [
  {
    ...
    tabs: [
      ...
      // Regímenes (#360) se mudó ENTERO (gestión completa, no solo el toggle) a Página pública →
      // Motor de reservas: quedaba raro tener el catálogo acá y el interruptor de mostrarlo allá.
