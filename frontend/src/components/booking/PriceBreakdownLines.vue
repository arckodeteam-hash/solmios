...
/** #360 — etiqueta de la fila: el `name` del snapshot de la línea; sin él, la key i18n legacy
 *  del código o el código crudo (`mealPlanDisplayName`, regla única en utils/meal-plans.ts). */
function mealPlanLabel(line: Pick<MealPlanLine, 'code' | 'name'>): string {
  return mealPlanDisplayName(line.code, line.name, t)
}
