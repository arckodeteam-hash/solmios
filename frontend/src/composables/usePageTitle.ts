...
export const ROUTE_LABELS: Record<string, string> = {
  ...
  'whatsapp-inbox': 'WhatsApp de huéspedes',
  ...
  groups: 'Grupos',
  packages: 'Paquetes y promociones',
  opiniones: 'Reseñas',
  resenas: 'Reseñas',
  crm: 'CRM',
  ai: 'IA',
  ...
  whatsapp: 'WhatsApp de huéspedes',
  facturacion: 'Facturación',
  'links-pago': 'Links de Pago',
  reportes: 'Reportes',
  grupos: 'Grupos',
  promociones: 'Paquetes y promociones',
  ...
  'mis-mesas': 'Mis mesas',   // /panel/kds — KDS en kiosco, sin layout del panel
  salon: 'Salón',
