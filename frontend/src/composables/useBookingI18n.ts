...
const messages = {
  es: {
    ...
    // Feature adultos+niños+edades (2026-09-02) — reemplaza la matriz "Para 1/Para 2".
    'rooms.guests.adults': 'Adultos',
    'rooms.guests.children': 'Niños',
    'rooms.guests.childAge': 'Edad del niño {n}',
    // Tarea 21 (Identificar bebés, 2026-09-08) — etiqueta junto al selector de edad cuando la
    // política del hotel clasifica esa edad como bebé (subconjunto de "no consume plaza").
    'rooms.guests.babyBadge': 'Bebé — no consume plaza',
    ...
    'rooms.board.included': 'Incluido',
    'rooms.board.perPersonNight': '{price} por persona y noche',
    ...
    'upsells.kindPerNight': 'Por noche',
    'upsells.kindPerPersonPerNight': 'Por persona y noche',
    ...
    'pay.mealPlan': 'Régimen',
    'pay.mealPlanLine': '{label} · {persons} pers × {nights} noches',
    'pay.mealPlanLineOne': '{label} · {persons} pers × 1 noche',
    'pay.mealPlanIncluded': 'incluido',
    ...
    'pay.taxes': 'Impuestos',
    'pay.beforeTaxes': 'sin impuestos',
    'pay.noTaxes': 'Este hotel no aplica impuestos sobre la reserva.',
    'pay.totalHint': 'Es exactamente el importe que se cobra en la pasarela.',
    ...
    'confirm.cribUnavailableNotice': 'La cuna no está disponible en la habitación asignada; el hotel se pondrá en contacto.',
    'confirm.checkIn': 'Check-in',
    'confirm.checkOut': 'Check-out',
    'confirm.guest': 'Huésped',
    'confirm.total': 'Total',
    'confirm.lodging': 'Alojamiento',
    'confirm.paid': 'Pagado',
    ...
    'confirm.unverifiedBody': 'No pudimos verificar el pago con la pasarela. Si te cobraron, guardá el comprobante y escribile al hotel con tu número de reserva: no vamos a cobrarte dos veces.',
    'confirm.retry': 'Revisar de nuevo',
    'confirm.downloadReceipt': 'Descargar recibo (PDF)',
    ...
    // #241 — página de confirmación rediseñada (identidad del hotel, contacto, fechas legibles).
    'confirm.bookingNumber': 'Número de reserva',
    'confirm.copy': 'Copiar',
    'confirm.copied': 'Copiado',
    'confirm.copyAria': 'Copiar número de reserva',
    'confirm.stayTitle': 'Tu estadía',
    'confirm.nights': '{count} {count, plural, one {noche} other {noches}}',
    'confirm.paymentTitle': 'Pago',
    'confirm.nextTitle': 'Qué sigue',
    'confirm.checkInFrom': 'Check-in a partir de las {time}',
    'confirm.checkOutUntil': 'Check-out hasta las {time}',
    'confirm.nextArrive': 'Al llegar, mencioná tu número de reserva en recepción.',
    'confirm.contactTitle': '¿Necesitás algo antes de llegar?',
    'confirm.contactBody': 'Escribile o llamá al hotel: te responden directamente.',
    'confirm.call': 'Llamar',
    'confirm.whatsapp': 'WhatsApp',
    'confirm.emailAction': 'Email',
    'confirm.cancelLink': '¿Necesitás cancelar esta reserva?',
    'confirm.cancelTitle': 'Cancelar reserva',
    'confirm.cancelBody': '¿Seguro que querés cancelar tu reserva? Esta acción no se puede deshacer. El monto del reembolso depende de la política de cancelación del hotel.',
    'confirm.cancelKeep': 'No, mantener',
    'confirm.cancelYes': 'Sí, cancelar',
    'confirm.cancelling': 'Cancelando…',
    'confirm.cancelErrorIds': 'No pudimos verificar tu reserva para cancelar.',
    'confirm.cancelErrorDefault': 'No se pudo cancelar. Intentá de nuevo o contactá al hotel.',
    'confirm.cancelledTitle': 'Reserva cancelada',
    'confirm.cancelledBody': 'Tu reserva fue cancelada correctamente.',
    'confirm.refund': 'Reembolso',
  ...
  en: {
    ...
    'rooms.guests.adults': 'Adults',
    'rooms.guests.children': 'Children',
    'rooms.guests.childAge': 'Child {n} age',
    ...
    'rooms.board.included': 'Included',
    'rooms.board.perPersonNight': '{price} per person per night',
    ...
    'upsells.kindPerNight': 'Per night',
    'upsells.kindPerPersonPerNight': 'Per person per night',
    ...
    'pay.mealPlan': 'Board',
    'pay.mealPlanLine': '{label} · {persons} guests × {nights} nights',
    'pay.mealPlanLineOne': '{label} · {persons} guests × 1 night',
    'pay.mealPlanIncluded': 'included',
    'pay.extrasCountOne': '1 extra',
    'pay.extrasCountMany': '{count} extras',
    'pay.guest': 'Guest',
    ...
    'pay.taxes': 'Taxes',
    'pay.beforeTaxes': 'before taxes',
    'pay.noTaxes': 'This hotel applies no taxes to the booking.',
    'pay.totalHint': 'This is exactly the amount charged at checkout.',
    ...
    'confirm.cribUnavailableNotice': 'The crib is not available in the assigned room; the hotel will get in touch with you.',
    'confirm.checkIn': 'Check-in',
    'confirm.checkOut': 'Check-out',
    'confirm.guest': 'Guest',
    'confirm.total': 'Total',
    'confirm.lodging': 'Lodging',
    'confirm.paid': 'Paid',
    ...
    'confirm.unverifiedBody': 'We could not verify the payment with the gateway. If you were charged, keep the receipt and contact the hotel with your booking number: you will not be charged twice.',
    'confirm.retry': 'Check again',
    'confirm.downloadReceipt': 'Download receipt (PDF)',
    ...
    'confirm.copyAria': 'Copy booking number',
    'confirm.stayTitle': 'Your stay',
    'confirm.nights': '{count} {count, plural, one {night} other {nights}}',
    'confirm.paymentTitle': 'Payment',
    'confirm.nextTitle': 'What happens next',
    'confirm.checkInFrom': 'Check-in from {time}',
    'confirm.checkOutUntil': 'Check-out until {time}',
    'confirm.nextArrive': 'On arrival, give your booking number at the front desk.',
    'confirm.contactTitle': 'Need anything before you arrive?',
    'confirm.contactBody': 'Message or call the hotel — they reply directly.',
    'confirm.call': 'Call',
    'confirm.whatsapp': 'WhatsApp',
    'confirm.emailAction': 'Email',
    'confirm.cancelLink': 'Need to cancel this booking?',
    'confirm.cancelTitle': 'Cancel booking',
    'confirm.cancelBody': 'Are you sure you want to cancel your booking? This cannot be undone. The refund amount depends on the hotel’s cancellation policy.',
    'confirm.cancelKeep': 'No, keep it',
    'confirm.cancelYes': 'Yes, cancel',
    'confirm.cancelling': 'Cancelling…',
    'confirm.cancelErrorIds': 'We could not verify your booking to cancel it.',
    'confirm.cancelErrorDefault': 'The booking could not be cancelled. Try again or contact the hotel.',
    'confirm.cancelledTitle': 'Booking cancelled',
    'confirm.cancelledBody': 'Your booking was cancelled.',
  ...
  pt: {
    ...
    'rooms.guests.adults': 'Adultos',
    'rooms.guests.children': 'Crianças',
    'rooms.guests.childAge': 'Idade da criança {n}',
    ...
    'rooms.board.included': 'Incluído',
    'rooms.board.perPersonNight': '{price} por pessoa e noite',
    ...
    'upsells.kindPerNight': 'Por noite',
    'upsells.kindPerPersonPerNight': 'Por pessoa e noite',
    ...
    'pay.mealPlan': 'Regime',
    'pay.mealPlanLine': '{label} · {persons} pessoas × {nights} noites',
    'pay.mealPlanLineOne': '{label} · {persons} pessoas × 1 noite',
    'pay.mealPlanIncluded': 'incluído',
    'pay.extrasCountOne': '1 extra',
    'pay.extrasCountMany': '{count} extras',
    'pay.guest': 'Hóspede',
    ...
    'pay.taxes': 'Impostos',
    'pay.beforeTaxes': 'sem impostos',
    'pay.noTaxes': 'Este hotel não aplica impostos sobre a reserva.',
    'pay.totalHint': 'É exatamente o valor cobrado no checkout.',
    ...
    'confirm.cribUnavailableNotice': 'O berço não está disponível no quarto atribuído; o hotel entrará em contato.',
    'confirm.checkIn': 'Check-in',
    'confirm.checkOut': 'Check-out',
    'confirm.guest': 'Hóspede',
    'confirm.total': 'Total',
    'confirm.lodging': 'Hospedagem',
    'confirm.paid': 'Pago',
    ...
    'confirm.unverifiedBody': 'Não conseguimos verificar o pagamento com o gateway. Se foi cobrado, guarde o comprovante e fale com o hotel com o número da reserva: não será cobrado duas vezes.',
    'confirm.retry': 'Verificar de novo',
    'confirm.downloadReceipt': 'Baixar recibo (PDF)',
    ...
    'confirm.bookingNumber': 'Número da reserva',
    'confirm.copy': 'Copiar',
    'confirm.copied': 'Copiado',
    'confirm.copyAria': 'Copiar número da reserva',
    'confirm.stayTitle': 'Sua estadia',
    'confirm.nights': '{count} {count, plural, one {noite} other {noites}}',
    'confirm.paymentTitle': 'Pagamento',
    'confirm.nextTitle': 'O que vem agora',
    'confirm.checkInFrom': 'Check-in a partir das {time}',
    'confirm.checkOutUntil': 'Check-out até as {time}',
    'confirm.nextArrive': 'Ao chegar, informe o número da reserva na recepção.',
    'confirm.contactTitle': 'Precisa de algo antes de chegar?',
    'confirm.contactBody': 'Escreva ou ligue para o hotel: eles respondem diretamente.',
    'confirm.call': 'Ligar',
    'confirm.whatsapp': 'WhatsApp',
    'confirm.emailAction': 'Email',
    'confirm.cancelLink': 'Precisa cancelar esta reserva?',
    'confirm.cancelTitle': 'Cancelar reserva',
    'confirm.cancelBody': 'Tem certeza de que quer cancelar sua reserva? Esta ação não pode ser desfeita. O valor do reembolso depende da política de cancelamento do hotel.',
    'confirm.cancelKeep': 'Não, manter',
    'confirm.cancelYes': 'Sim, cancelar',
    'confirm.cancelling': 'Cancelando…',
    'confirm.cancelErrorIds': 'Não conseguimos verificar sua reserva para cancelar.',
    'confirm.cancelErrorDefault': 'Não foi possível cancelar. Tente de novo ou fale com o hotel.',
    'confirm.cancelledTitle': 'Reserva cancelada',
    'confirm.cancelledBody': 'Sua reserva foi cancelada.',
    'confirm.refund': 'Reembolso',
