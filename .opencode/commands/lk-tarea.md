---
description: Hacer una tarea de punta a punta con minions, verificada y autocorregida
argument-hint: <qué hay que hacer>
---
# TAREA: $ARGUMENTS

Abrí la tarea con un id corto que la describa:

```bash
bash .loopkit/core/lk start T-<id> "$ARGUMENTS"
```
...
No pares a la mitad para preguntar si seguís. Preguntá sólo si hay una decisión de
negocio que sólo el humano puede tomar, y preguntá una sola cosa, clara.
